...
document.addEventListener("DOMContentLoaded", function () {
        ...
        document.querySelector("#buttonBlur").addEventListener("click", getBlurFilter);
        ...
        function getBlurFilter() {
                ...
                for (let x = 1; x < imageData.width - 1; x++) {
                        for (let y = 1; y < imageData.height - 1; y++) {
                                averageData(imageData, x, y, matriz, r, g, b, index);
                                index = (x + y * imageData.width) * 4;
                        }
                }
                ctx.putImageData(imageData, 0, 0);
        ...
        function averageData(imageData, x, y, matriz, r, g, b, index) {
        ...
        function getSaturation() {
                ...
                for (let x = 0; x < imageData.width; x++) {
                        for (let y = 0; y < imageData.height; y++) {
                                ...
                                imageData.data[index + 0] = rgb[0]; //RED
