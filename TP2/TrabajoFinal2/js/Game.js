...
function start() {
    ...
    document.querySelector("#turnPlayerRed").className = "h2";
}
...
function changeTurn() {
    if (turn === player1) {
        turn = player2;
        document.querySelector("#turnPlayerRed").className = "Hidden";
        document.querySelector("#turnPlayerBlue").className = "h2";
    } else {
        turn = player1;
        document.querySelector("#turnPlayerRed").className = "h2";
